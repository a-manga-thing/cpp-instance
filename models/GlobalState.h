...
class GlobalState
{
  public:
     ...
     */
    explicit GlobalState(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit GlobalState(const Json::Value &pJson) noexcept(false);
     ...
     */
    GlobalState(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    void setLastUpdateToNull() noexcept;
