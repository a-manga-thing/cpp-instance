...
Chapter::Chapter(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[13].empty() && pJson.isMember(pMasqueradingVector[13]))
    {
        ...
        {
            update_=std::make_shared<uint64_t>((uint64_t)pJson[pMasqueradingVector[13]].asUInt64());
        }
    }
}
    ...
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 14)
    {
        ...
        if(!pMasqueradingVector[13].empty())
        {
            if(getUpdate())
            {
                ret[pMasqueradingVector[13]]=(Json::UInt64)getValueOfUpdate();
            }
            else
            {
...
bool Chapter::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("update"))
    {
        if(!validJsonOfField(13, "update", pJson["update"], err, true))
            return false;
    }
    return true;
}
...
bool Chapter::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("update"))
    {
        if(!validJsonOfField(13, "update", pJson["update"], err, false))
            return false;
    }
    return true;
}
